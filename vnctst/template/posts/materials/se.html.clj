 ...
 [:li
  ...
  [:ul
   [:li [:small
         "これはほぼ"
         (a-href-external "https://creativecommons.org/publicdomain/zero/1.0/deed.ja" "CC0")
         "と同じなのですが、CC0だと著作権を放棄してしまう為、例えば「自分が作った素材をCC0にしていたら、○○という大手メディア会社が『この素材は○○が権利を保有している、お前は使うな』と勝手に著作権を主張してきた」というような事がもし起こった際に立場が弱くなってしまう恐れがあるので、このようにしています。なおCC-BYだと「権利者表記が必要」となり、これはこれで利用の手軽さが失われてしまうので避けています"]]]
  ]
 ]
