...
[:ul [:li [:dl
           ...
           [:dd "しかし時間の経過と共に、Google Playでの公開に必要な手順がどんどん増加して手間になり、これらが今後にまた減る事はなさそうな為、手順の省力化の為に、以下の方針に改める事とした。"]
           [:dd
            [:ol
             [:li "とりあえずhtml5ベースのブラゲとして作って普通に公開する"]
...
[:ul [:li [:dl
           ...
           [:dd "ただし、単純な広告ではなく、元コンテンツを盛り上げる効果のある内容(コラボその他)の場合は採用を検討したい。"]
           ]]]
[:ul [:li [:dl
